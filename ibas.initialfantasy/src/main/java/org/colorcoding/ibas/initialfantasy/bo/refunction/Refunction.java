...
@XmlType(name = Refunction.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = Refunction.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = Refunction.BUSINESS_OBJECT_CODE)
public class Refunction extends BusinessObject<Refunction> implements IRefunction {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -3904217562136109403L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = Refunction.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SYS_ORFN";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "Refunction";
	 ...
	 * 指派类型 属性
	 */
	@DbField(name = "AssignedType", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 指派目标 属性
	 */
	@DbField(name = "Assigned", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
