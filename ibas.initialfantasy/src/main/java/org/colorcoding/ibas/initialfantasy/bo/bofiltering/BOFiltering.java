...
@BusinessObjectUnit(code = BOFiltering.BUSINESS_OBJECT_CODE)
public class BOFiltering extends BusinessObject<BOFiltering> implements IBOFiltering {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -8676793977622218216L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = BOFiltering.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SYS_OBFT";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "BOFiltering";
	 ...
	 * 角色标识 属性
	 */
	@DbField(name = "RoleCode", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 对象类型 属性
	 */
	@DbField(name = "BOCode", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 类别 属性
	 */
	@DbField(name = "Category", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 筛选类型 属性
	 */
	@DbField(name = "FilteringType", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 属性名称-业务对象筛选-条件
	 */
	private static final String PROPERTY_BOFILTERINGCONDITIONS_NAME = "BOFilteringConditions";

	/**
	 * 业务对象筛选-条件的集合属性
	 * 
	 */
	public static final IPropertyInfo<IBOFilteringConditions> PROPERTY_BOFILTERINGCONDITIONS = registerProperty(
			PROPERTY_BOFILTERINGCONDITIONS_NAME, IBOFilteringConditions.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElementWrapper(name = PROPERTY_BOFILTERINGCONDITIONS_NAME)
	@XmlElement(name = BOFilteringCondition.BUSINESS_OBJECT_NAME, type = BOFilteringCondition.class)
	public final IBOFilteringConditions getBOFilteringConditions() {
		return this.getProperty(PROPERTY_BOFILTERINGCONDITIONS);
	}
