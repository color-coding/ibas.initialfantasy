...
@XmlType(name = BOInformation.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
public class BOInformation extends BusinessObject<BOInformation> implements IBOInformation {
