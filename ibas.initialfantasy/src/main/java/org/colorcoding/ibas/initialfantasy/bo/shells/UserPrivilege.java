...
@XmlType(name = UserPrivilege.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
@XmlRootElement(name = UserPrivilege.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
