...
@XmlType(name = ApprovalRequest.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
@XmlRootElement(name = ApprovalRequest.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
