...
public class BOPropertySetting extends BusinessObject<BOPropertySetting> implements IBOPropertySetting {
	 ...
	 * 对象 属性
	 */
	@DbField(name = "Object", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 属性 属性
	 */
	@DbField(name = "Property", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 身份 属性
	 */
	@DbField(name = "Identity", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 权限 属性
	 */
	@DbField(name = "Authorised", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 必填 属性
	 */
	@DbField(name = "Required", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 宽度 属性
	 */
	@DbField(name = "Width", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
