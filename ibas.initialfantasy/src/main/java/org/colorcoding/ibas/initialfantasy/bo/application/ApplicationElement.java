...
@XmlType(name = ApplicationElement.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = ApplicationElement.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = ApplicationElement.BUSINESS_OBJECT_CODE)
public class ApplicationElement extends BusinessObject<ApplicationElement> implements IApplicationElement {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -3476154275105805785L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = ApplicationElement.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SYS_ELEMENT";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_SYS_ELEMENT";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "ApplicationElement";
	 ...
	 * 模块标识 属性
	 */
	@DbField(name = "ModuleId", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 属性名称-元素标识
	 */
	private static final String PROPERTY_ELEMENTID_NAME = "ElementId";

	/**
	 * 元素标识 属性
	 */
	@DbField(name = "ElementId", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_ELEMENTID_NAME)
	public final String getElementId() {
		return this.getProperty(PROPERTY_ELEMENTID);
	}
	 ...
	 * 属性名称-元素名称
	 */
	private static final String PROPERTY_ELEMENTNAME_NAME = "ElementName";

	/**
	 * 元素名称 属性
	 */
	@DbField(name = "ElementName", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	public static final IPropertyInfo<String> PROPERTY_ELEMENTNAME = registerProperty(PROPERTY_ELEMENTNAME_NAME,
			String.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_ELEMENTNAME_NAME)
	public final String getElementName() {
		return this.getProperty(PROPERTY_ELEMENTNAME);
	}
	 ...
	 * 属性名称-元素类型
	 */
	private static final String PROPERTY_ELEMENTTYPE_NAME = "ElementType";

	/**
	 * 元素类型 属性
	 */
	@DbField(name = "ElementType", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	public static final IPropertyInfo<emElementType> PROPERTY_ELEMENTTYPE = registerProperty(PROPERTY_ELEMENTTYPE_NAME,
			emElementType.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_ELEMENTTYPE_NAME)
	public final emElementType getElementType() {
		return this.getProperty(PROPERTY_ELEMENTTYPE);
	}
