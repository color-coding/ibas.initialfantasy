...
@XmlType(name = ApplicationModule.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
@XmlRootElement(name = ApplicationModule.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
