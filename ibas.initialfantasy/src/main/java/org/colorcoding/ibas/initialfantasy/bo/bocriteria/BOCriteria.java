...
@BusinessObjectUnit(code = BOCriteria.BUSINESS_OBJECT_CODE)
public class BOCriteria extends BusinessObject<BOCriteria> implements IBOCriteria {
	 ...
	 * 应用标识 属性
	 */
	@DbField(name = "AppId", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 查询数据 属性
	 */
	@DbField(name = "Data", type = DataType.MEMO, table = DB_TABLE_NAME)
