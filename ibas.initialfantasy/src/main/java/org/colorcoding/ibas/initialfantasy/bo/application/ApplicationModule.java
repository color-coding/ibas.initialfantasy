...
public class ApplicationModule extends BusinessObject<ApplicationModule> implements IApplicationModule {
	 ...
	 * 模块名称 属性
	 */
	@DbField(name = "ModuleName", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME, primaryKey = false)
	 ...
	 * 模块类别 属性
	 */
	@DbField(name = "ModuleCategory", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME, primaryKey = false)
