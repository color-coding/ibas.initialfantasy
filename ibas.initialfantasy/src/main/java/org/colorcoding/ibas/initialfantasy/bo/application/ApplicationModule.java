...
public class ApplicationModule extends BusinessObject<ApplicationModule> implements IApplicationModule {
	 ...
	 * 模块名称 属性
	 */
	@DbField(name = "ModuleName", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 模块类别 属性
	 */
	@DbField(name = "ModuleCategory", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 模块入口 属性
	 */
	@DbField(name = "ModuleEntry", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME)
