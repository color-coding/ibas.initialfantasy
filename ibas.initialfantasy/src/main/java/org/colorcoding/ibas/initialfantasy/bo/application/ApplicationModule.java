...
@XmlType(name = ApplicationModule.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = ApplicationModule.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = ApplicationModule.BUSINESS_OBJECT_CODE)
public class ApplicationModule extends BusinessObject<ApplicationModule> implements IApplicationModule {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -539083373179201553L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = ApplicationModule.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SYS_MODULE";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_SYS_MODULE";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "ApplicationModule";
	 ...
	 * 平台标识 属性
	 */
	@DbField(name = "PlatformId", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 属性名称-模块名称
	 */
	private static final String PROPERTY_MODULENAME_NAME = "ModuleName";

	/**
	 * 模块名称 属性
	 */
	@DbField(name = "ModuleName", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	public static final IPropertyInfo<String> PROPERTY_MODULENAME = registerProperty(PROPERTY_MODULENAME_NAME,
			String.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_MODULENAME_NAME)
	public final String getModuleName() {
		return this.getProperty(PROPERTY_MODULENAME);
	}
	...
	public final void setModuleName(String value) {
		this.setProperty(PROPERTY_MODULENAME, value);
	}
	 ...
	 * 模块类别 属性
	 */
	@DbField(name = "ModuleCategory", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	public static final IPropertyInfo<String> PROPERTY_MODULECATEGORY = registerProperty(PROPERTY_MODULECATEGORY_NAME,
			String.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_MODULECATEGORY_NAME)
	public final String getModuleCategory() {
		return this.getProperty(PROPERTY_MODULECATEGORY);
	}
	 ...
	 *            值
	 */
	public final void setModuleCategory(String value) {
		this.setProperty(PROPERTY_MODULECATEGORY, value);
	}
	 ...
	 * 模块入口 属性
	 */
	@DbField(name = "ModuleEntry", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
