...
public class RefunctionItem extends BusinessObject<RefunctionItem> implements IRefunctionItem {
	 ...
	 * 父项 属性
	 */
	@DbField(name = "Parent", type = DataType.NUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 功能 属性
	 */
	@DbField(name = "Function", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 图片 属性
	 */
	@DbField(name = "Image", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
