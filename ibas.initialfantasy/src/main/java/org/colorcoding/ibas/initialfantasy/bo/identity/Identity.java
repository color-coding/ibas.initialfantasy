...
@XmlType(name = Identity.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = Identity.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = Identity.BUSINESS_OBJECT_CODE)
public class Identity extends BusinessObject<Identity> implements IIdentity {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -5411386886746480580L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = Identity.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SYS_IDNTY";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_SYS_IDENTITY";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "Identity";
