...
@XmlType(name = ApplicationFunction.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = ApplicationFunction.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = ApplicationFunction.BUSINESS_OBJECT_CODE)
public class ApplicationFunction extends BusinessObject<ApplicationFunction> implements IApplicationFunction {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 6130588955392080915L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = ApplicationFunction.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SYS_FUNCTION";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_SYS_FUNCTION";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "ApplicationFunction";
	 ...
	 * 功能标识 属性
	 */
	@DbField(name = "FunctionId", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 属性名称-功能名称
	 */
	private static final String PROPERTY_FUNCTIONNAME_NAME = "FunctionName";

	/**
	 * 功能名称 属性
	 */
	@DbField(name = "FunctionName", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	public static final IPropertyInfo<String> PROPERTY_FUNCTIONNAME = registerProperty(PROPERTY_FUNCTIONNAME_NAME,
			String.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_FUNCTIONNAME_NAME)
	public final String getFunctionName() {
		return this.getProperty(PROPERTY_FUNCTIONNAME);
	}
	...
	public final void setFunctionName(String value) {
		this.setProperty(PROPERTY_FUNCTIONNAME, value);
	}
	 ...
	 * 创建时间 属性
	 */
	@DbField(name = "CreateTime", type = DataType.NUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 修改时间 属性
	 */
	@DbField(name = "UpdateTime", type = DataType.NUMERIC, table = DB_TABLE_NAME)
