...
public class ApplicationConfig extends BusinessObject<ApplicationConfig> implements IApplicationConfig {
	 ...
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -2007818285340516338L;
	 ...
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SYS_CONFIG";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_SYS_CONFIG";
	 ...
	 * 配置组 属性
	 */
	@DbField(name = "ConfigGroup", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 配置项 属性
	 */
	@DbField(name = "ConfigKey", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 配置说明 属性
	 */
	@DbField(name = "ConfigDescrp", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 配置值 属性
	 */
	@DbField(name = "ConfigValue", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
