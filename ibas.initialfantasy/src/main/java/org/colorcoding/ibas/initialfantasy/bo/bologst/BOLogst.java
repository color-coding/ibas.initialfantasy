...
public class BOLogst extends BusinessObject<BOLogst> implements IBOLogst, IBOCustomKey {
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_MODIFYUSER_NAME)
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_MODIFYDATE_NAME)
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_MODIFYTIME_NAME)
