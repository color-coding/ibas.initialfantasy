...
@XmlType(name = ApprovalTemplate.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
@XmlRootElement(name = ApprovalTemplate.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
