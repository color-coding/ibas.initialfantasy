...
@XmlType(name = Privilege.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@XmlRootElement(name = Privilege.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
@BusinessObjectUnit(code = Privilege.BUSINESS_OBJECT_CODE)
public class Privilege extends BusinessObject<Privilege> implements IPrivilege {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 4916555078788071399L;
	 ...
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SYS_PRIVILEGE";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_SYS_PRIVILEGE";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "Privilege";
	 ...
	 * 目标标识 属性
	 */
	@DbField(name = "Target", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME, uniqueKey = true)
	 ...
	 * 自动运行 属性
	 */
	@DbField(name = "Automatic", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
