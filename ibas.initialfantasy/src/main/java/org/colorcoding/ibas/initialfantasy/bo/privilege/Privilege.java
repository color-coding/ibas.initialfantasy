...
@XmlType(name = Privilege.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
@XmlRootElement(name = Privilege.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
