...
@BusinessObjectUnit(code = Organization.BUSINESS_OBJECT_CODE)
public class Organization extends BusinessObject<Organization>
		implements IOrganization, IDataOwnership, IBOSeriesKey, IBOUserFields {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 2978736666636179236L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = Organization.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_SYS_ORGANIZATION";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_SYS_ORGANIZATION";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "Organization";
	 ...
	 * 属性名称-组
	 */
	private static final String PROPERTY_GROUPED_NAME = "Grouped";

	/**
	 * 组 属性
	 */
	@DbField(name = "Grouped", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	public static final IPropertyInfo<emYesNo> PROPERTY_GROUPED = registerProperty(PROPERTY_GROUPED_NAME, emYesNo.class,
			MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElement(name = PROPERTY_GROUPED_NAME)
	public final emYesNo getGrouped() {
		return this.getProperty(PROPERTY_GROUPED);
	}
	 ...
	 * @param value 值
	 */
	public final void setGrouped(emYesNo value) {
		this.setProperty(PROPERTY_GROUPED, value);
	}
	 ...
	 * 生效日期 属性
	 */
	@DbField(name = "ValidDate", type = DataType.DATE, editType = EditType.DATE, table = DB_TABLE_NAME)
	 ...
	 * 失效日期 属性
	 */
	@DbField(name = "InvalidDate", type = DataType.DATE, editType = EditType.DATE, table = DB_TABLE_NAME)
