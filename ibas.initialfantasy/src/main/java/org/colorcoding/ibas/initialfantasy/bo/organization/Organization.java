...
@XmlType(name = Organization.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
@XmlRootElement(name = Organization.BUSINESS_OBJECT_NAME, namespace = MyConsts.NAMESPACE_BO)
