...
public class OwnershipJudger extends org.colorcoding.ibas.bobas.ownership.OwnershipJudger {
	...
	public boolean canSave(IDataOwnership data, IUser user) {
		try {
			...
			if (filtered && data instanceof ITrackable) {
				ITrackable trackStatus = (ITrackable) data;
