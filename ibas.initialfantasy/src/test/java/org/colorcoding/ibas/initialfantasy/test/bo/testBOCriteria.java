 ...
 * 
 */
public class testBOCriteria extends TestCase {
	/**
	 * 获取连接口令
	 */
	String getToken() {
	...
	public void testBasicItems() throws Exception {
		...
		// 测试保存
		operationResult = boRepository.saveBOCriteria(bo);
		assertEquals(operationResult.getMessage(), operationResult.getResultCode(), 0);
		BOCriteria boSaved = (BOCriteria) operationResult.getResultObjects().firstOrDefault();
