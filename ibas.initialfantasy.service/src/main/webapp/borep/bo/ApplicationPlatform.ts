...
import {
    IApplicationPlatform,BO_CODE_APPLICATIONPLATFORM
} from "../../api/index";
...
export class ApplicationPlatform extends BOSimple<ApplicationPlatform> implements IApplicationPlatform {
    ...
    get activated(): emYesNo {
        return this.getProperty<emYesNo>(ApplicationPlatform.PROPERTY_ACTIVATED_NAME);
    }
    /** 设置-是否可用 */
    ...
    /** 初始化数据 */
    protected init(): void {
        this.objectCode = config.applyVariables(ApplicationPlatform.BUSINESS_OBJECT_CODE);
    }
}
