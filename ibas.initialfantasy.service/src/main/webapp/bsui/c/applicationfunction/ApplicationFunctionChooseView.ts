...
import { IApplicationFunctionChooseView } from "../../../bsapp/applicationfunction/index";

/**
 * 视图-ApplicationFunction
 */
export class ApplicationFunctionChooseView extends ibas.BOChooseView implements IApplicationFunctionChooseView {
    /** 返回查询的对象 */
    get queryTarget(): any {
