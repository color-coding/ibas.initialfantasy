...
export class ApprovalRequestEditView extends ibas.BOEditView implements IApprovalRequestEditView {
    ...
    darw(): any {
        ...
        this.form.addContent(new sap.ui.core.Title("", { text: ibas.i18n.prop("bo_ApprovalRequestitem") }));
            ...
            extension: new sap.m.Toolbar("", {
                content: [
                    new sap.m.Button("", {
                        ...
                        icon: "sap-icon://add",
                        press: function (): void {
                            that.fireViewEvents(that.addApprovalRequestItemEvent);
                        }
                    }),
                    new sap.m.Button("", {
                        ...
                        icon: "sap-icon://less",
                        press: function (): void {
                            that.fireViewEvents(that.removeApprovalRequestItemEvent);
                        }
                    })
                ]
            }),
