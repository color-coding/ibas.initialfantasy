define(["require", "exports", "ibas/index", "openui5/typings/ibas.utils"], function (require, exports, ibas, ibas_utils_1) {
    ...
    class ApprovalRequestEditView extends ibas.BOEditView {
        darw() {
            let that = this;
        ...
        showApprovalRequestSteps(datas) {
            this.tableApprovalRequestStep.setModel(new sap.ui.model.json.JSONModel(datas));
            ibas_utils_1.utils.refreshModelChanged(this.tableApprovalRequestStep, datas);
        }
    }
    exports.ApprovalRequestEditView = ApprovalRequestEditView;
});
