...
import { IProjectListView } from "../../../bsapp/project/index";

/**
 * 列表视图-项目
 */
export class ProjectListView extends ibas.BOListView implements IProjectListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
        return bo.Project;
    }
    ...
    getSelecteds(): bo.Project[] {
        return openui5.utils.getSelecteds<bo.Project>(this.table);
    }
}
