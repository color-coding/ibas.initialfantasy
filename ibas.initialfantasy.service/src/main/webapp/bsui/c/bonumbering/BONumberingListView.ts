...
import { ibas.IBONumberingListView } from "../../../bsapp/bonumbering/index";

/**
 * 列表视图-业务对象编号方式
 */
export class BONumberingListView extends ibas.BOQueryView implements ibas.IBONumberingListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
