...
import { ibas.IBONumberingEditView } from "../../../bsapp/bonumbering/index";

/**
 * 编辑视图-业务对象编号方式
 */
export class BONumberingEditView extends ibas.BOView implements ibas.IBONumberingEditView {
