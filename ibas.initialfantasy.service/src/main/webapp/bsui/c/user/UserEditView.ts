...
export class UserEditView extends ibas.BOEditView implements IUserEditView {
    ...
    darw(): any {
        ...
        this.form.addContent(new sap.ui.core.Title("", { text: ibas.i18n.prop("bo_Useritem") }));
            ...
            extension: new sap.m.Toolbar("", {
                content: [
                    new sap.m.Button("", {
                        ...
                        icon: "sap-icon://add",
                        press: function (): void {
                            that.fireViewEvents(that.addUserItemEvent);
                        }
                    }),
                    new sap.m.Button("", {
                        ...
                        icon: "sap-icon://less",
                        press: function (): void {
                            that.fireViewEvents(that.removeUserItemEvent);
                        }
                    })
                ]
            }),
