...
import { IOrganizationChooseView } from "../../../bsapp/organization/index";

/**
 * 视图-Organization
 */
export class OrganizationChooseView extends ibas.BOChooseView implements IOrganizationChooseView {
    /** 返回查询的对象 */
    get queryTarget(): any {
