...
import { IOrganizationListView } from "../../../bsapp/organization/index";

/**
 * 视图-Organization
 */
export class OrganizationListView extends ibas.BOListView implements IOrganizationListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
    ...
    darw(): any {
        ...
        this.table = new sap.ui.table.Table("", {
            ...
            columns: [
                ...
                new sap.ui.table.Column("", {
                    label: ibas.i18n.prop("bo_organization_name"),
                    template: new sap.m.Text("", {
                        wrapping: false
                    }).bindProperty("text", {
                        path: "name"
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                openui5.utils.getTableSelecteds<bo.Organization>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    */
    ...
    getSelecteds(): bo.Organization[] {
        return openui5.utils.getTableSelecteds<bo.Organization>(this.table);
    }
}
