...
import { IApplicationModuleListView } from "../../../bsapp/applicationmodule/index";

/**
 * 视图-ApplicationModule
 */
export class ApplicationModuleListView extends ibas.BOListView implements IApplicationModuleListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.ApplicationModule>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    */
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.deleteDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.ApplicationModule>(that.table)
                            );
                        }
                    }),
                ],
