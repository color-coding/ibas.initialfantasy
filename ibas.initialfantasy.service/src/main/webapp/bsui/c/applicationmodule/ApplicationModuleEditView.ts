...
namespace initialfantasy {
    export namespace ui {
        export namespace c {
             ...
             */
            export class ApplicationModuleEditView extends ibas.BOEditView implements app.IApplicationModuleEditView {
                /** 删除数据事件 */
                ...
                /** 改变视图状态 */
                private changeViewStatus(data: bo.ApplicationModule): void {
