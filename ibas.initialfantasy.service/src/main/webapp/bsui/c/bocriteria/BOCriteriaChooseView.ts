...
import { ibas.IBOCriteriaChooseView } from "../../../bsapp/bocriteria/index";

/**
 * 视图-BOCriteria
 */
export class BOCriteriaChooseView extends ibas.BOChooseView implements ibas.IBOCriteriaChooseView {
    /** 返回查询的对象 */
    get queryTarget(): any {
