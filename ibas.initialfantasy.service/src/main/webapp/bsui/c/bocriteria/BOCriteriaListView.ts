...
import { ibas.IBOCriteriaListView } from "../../../bsapp/bocriteria/index";

/**
 * 视图-BOCriteria
 */
export class BOCriteriaListView extends ibas.BOListView implements ibas.IBOCriteriaListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
