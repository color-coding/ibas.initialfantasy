...
import { IApplicationPlatformListView } from "../../../bsapp/applicationplatform/index";

/**
 * 视图-ApplicationPlatform
 */
export class ApplicationPlatformListView extends ibas.BOListView implements IApplicationPlatformListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.ApplicationPlatform>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    new sap.m.Button("", {
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.deleteDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.ApplicationPlatform>(that.table)
                            );
                        }
                    }),
                ],
