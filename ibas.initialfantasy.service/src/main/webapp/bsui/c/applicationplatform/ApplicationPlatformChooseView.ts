...
import { IApplicationPlatformChooseView } from "../../../bsapp/applicationplatform/index";

/**
 * 视图-ApplicationPlatform
 */
export class ApplicationPlatformChooseView extends ibas.BOChooseView implements IApplicationPlatformChooseView {
    /** 返回查询的对象 */
    get queryTarget(): any {
