...
import { IConfigChooseView } from "../../../bsapp/system/index";

/**
 * 视图-Config
 */
export class ConfigChooseView extends ibas.BOChooseView implements IConfigChooseView {
    /** 返回查询的对象 */
    get queryTarget(): any {
        ...
        this.table = new sap.ui.table.Table("", {
            ...
            columns: [
                new sap.ui.table.Column("", {
                    label: ibas.i18n.prop("bo_config_key"),
                ...
                new sap.ui.table.Column("", {
                    label: ibas.i18n.prop("bo_config_value"),
                    template: new sap.m.Text("", {
                        wrapping: false
                    }).bindProperty("text", {
                        path: "value"
