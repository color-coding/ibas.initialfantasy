...
import { IVariableChooseView } from "../../../bsapp/system/index";

/**
 * 视图-Variable
 */
export class VariableChooseView extends ibas.BOChooseView implements IVariableChooseView {
    /** 返回查询的对象 */
    get queryTarget(): any {
            ...
            new sap.m.Button("", {
                ...
                press: function (): void {
                    that.fireViewEvents(that.chooseDataEvent,
                        // 获取表格选中的对象
                        utils.getTableSelecteds<ibas.KeyValue>(that.table)
                    );
                }
            }),
            new sap.m.Button("", {
