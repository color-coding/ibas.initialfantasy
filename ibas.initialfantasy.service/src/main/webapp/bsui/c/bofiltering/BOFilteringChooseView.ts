...
import { IBOFilteringChooseView } from "../../../bsapp/bofiltering/index";

/**
 * 视图-BOFiltering
 */
export class BOFilteringChooseView extends ibas.BOChooseView implements IBOFilteringChooseView {
    /** 返回查询的对象 */
    get queryTarget(): any {
