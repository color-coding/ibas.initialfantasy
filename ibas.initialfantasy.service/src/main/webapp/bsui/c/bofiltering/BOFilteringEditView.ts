...
import { ibas.IBOFilteringEditView } from "../../../bsapp/bofiltering/index";

/**
 * 视图-BOFiltering
 */
export class BOFilteringEditView extends ibas.BOEditView implements ibas.IBOFilteringEditView {
    /** 删除数据事件 */
