...
import { ibas.IBOFilteringListView } from "../../../bsapp/bofiltering/index";

/**
 * 视图-BOFiltering
 */
export class BOFilteringListView extends ibas.BOListView implements ibas.IBOFilteringListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
