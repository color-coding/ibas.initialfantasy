...
import { IBOFilteringListView } from "../../../bsapp/bofiltering/index";

/**
 * 视图-BOFiltering
 */
export class BOFilteringListView extends ibas.BOListView implements IBOFilteringListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
        return bo.BOFiltering;
    }
    /** 编辑数据，参数：目标数据 */
    ...
    darw(): any {
        ...
        this.table = new sap.ui.table.Table("", {
            ...
            columns: [
                ...
                new sap.ui.table.Column("", {
                    label: ibas.i18n.prop("bo_bofiltering_bocode"),
                    template: new sap.m.Text("", {
                        wrapping: false
                    }).bindProperty("text", {
                        path: "boCode"
                ...
                new sap.ui.table.Column("", {
                    label: ibas.i18n.prop("bo_bofiltering_activated"),
                    template: new sap.m.Text("", {
                        wrapping: false
                    }).bindProperty("text", {
                        path: "activated",
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.BOFiltering>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    */
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.deleteDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.BOFiltering>(that.table)
                            );
                        }
                    }),
                ],
