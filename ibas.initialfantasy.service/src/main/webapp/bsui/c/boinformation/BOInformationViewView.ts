...
import { IBOInformationViewView } from "../../../bsapp/boinformation/index";

/**
 * 视图-BOInformation
 */
export class BOInformationViewView extends ibas.BOViewView implements IBOInformationViewView {
