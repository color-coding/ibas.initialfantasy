...
import { IPrivilegeListView } from "../../../bsapp/privilege/index";

/**
 * 视图-Privilege
 */
export class PrivilegeListView extends ibas.BOListView implements IPrivilegeListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
        return bo.Privilege;
    }
                    ...
                    new sap.m.Button("", {
                        ...
                        press: function (): void {
                            that.fireViewEvents(that.viewDataEvent,
                                // 获取表格选中的对象
                                utils.getTableSelecteds<bo.Privilege>(that.table).firstOrDefault()
                            );
                        }
                    }),
                    new sap.m.Button("", {
