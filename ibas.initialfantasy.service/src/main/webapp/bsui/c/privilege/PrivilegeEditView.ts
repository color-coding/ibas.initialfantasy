...
export class PrivilegeEditView extends ibas.BOEditView implements IPrivilegeEditView {
    ...
    darw(): any {
        ...
        this.form.addContent(new sap.ui.core.Title("", { text: ibas.i18n.prop("bo_Privilegeitem") }));
            ...
            extension: new sap.m.Toolbar("", {
                content: [
                    new sap.m.Button("", {
                        ...
                        icon: "sap-icon://add",
                        press: function (): void {
                            that.fireViewEvents(that.addPrivilegeItemEvent);
                        }
                    }),
                    new sap.m.Button("", {
                        ...
                        icon: "sap-icon://less",
                        press: function (): void {
                            that.fireViewEvents(that.removePrivilegeItemEvent);
                        }
                    })
                ]
            }),
