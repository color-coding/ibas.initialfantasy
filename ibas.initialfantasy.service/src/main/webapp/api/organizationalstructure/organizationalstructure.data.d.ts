...
/** 组织-结构 */
export interface IOrganizationalStructure extends IBusinessObject<IOrganizationalStructure> {
...
/** 组织-角色 */
export interface IOrganizationalRole extends IBusinessObject<OrganizationalRole> {
...
/** 组织-角色-成员 */
export interface IRoleMember extends IBusinessObject<RoleMember> {
