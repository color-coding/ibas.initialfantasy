...
/** 审批记录 */
export interface IApprovalRequest extends IBusinessObject<IApprovalRequest> {
...
/** 审批请求步骤 */
export interface IApprovalRequestStep extends IBusinessObject<ApprovalRequestStep> {
