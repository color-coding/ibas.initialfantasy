...
/** 查看应用-数据权限 */
export class OwnershipViewApp extends ibas.BOViewApplication<IOwnershipViewView> {

    /** 应用标识 */
    static APPLICATION_ID: string = "fab2d8f4-0ada-4e20-96fd-8accd369fd37";
    /** 应用名称 */
    static APPLICATION_NAME: string = "mu_initialfantasy_app_ownership_view";
    ...
    protected viewData: bo.Ownership;
    /** 运行,覆盖原方法 */
    run(...args: any[]): void {
