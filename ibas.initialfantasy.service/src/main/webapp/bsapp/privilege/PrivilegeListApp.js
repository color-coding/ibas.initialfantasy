define(["require", "exports", "ibas/index", "../../borep/bo/index", "../../borep/BORepositories", "./PrivilegeViewApp", "./PrivilegeEditApp"], function (require, exports, ibas, bo, BORepositories_1, PrivilegeViewApp_1, PrivilegeEditApp_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class PrivilegeListApp extends ibas.BOListApplication {
        constructor() {
            super();
        ...
        viewData(data) {
            ...
            let app = new PrivilegeViewApp_1.PrivilegeViewApp();
            app.navigation = this.navigation;
            app.viewShower = this.viewShower;
            app.run(data);
        }
    ...
    PrivilegeListApp.APPLICATION_ID = "f5f6df45-f0ae-44ec-b56f-5e87c3947ec1";
    PrivilegeListApp.APPLICATION_NAME = "initialfantasy_app_privilege_list";
    PrivilegeListApp.BUSINESS_OBJECT_CODE = bo.Privilege.BUSINESS_OBJECT_CODE;
    exports.PrivilegeListApp = PrivilegeListApp;
});
