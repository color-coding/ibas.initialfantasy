define(["require", "exports", "ibas/index", "../../borep/bo/index", "../../borep/BORepositories", "./OrganizationalStructureViewApp", "./OrganizationalStructureEditApp"], function (require, exports, ibas, bo, BORepositories_1, OrganizationalStructureViewApp_1, OrganizationalStructureEditApp_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class OrganizationalStructureListApp extends ibas.BOListApplication {
        constructor() {
            super();
        ...
        viewData(data) {
            ...
            let app = new OrganizationalStructureViewApp_1.OrganizationalStructureViewApp();
            app.navigation = this.navigation;
            app.viewShower = this.viewShower;
            app.run(data);
        }
    ...
    OrganizationalStructureListApp.APPLICATION_ID = "5b8faa6a-2a49-47c5-982b-31d550083e79";
    OrganizationalStructureListApp.APPLICATION_NAME = "initialfantasy_app_organizationalstructure_list";
    OrganizationalStructureListApp.BUSINESS_OBJECT_CODE = bo.OrganizationalStructure.BUSINESS_OBJECT_CODE;
    exports.OrganizationalStructureListApp = OrganizationalStructureListApp;
});
