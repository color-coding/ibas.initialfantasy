define(["require", "exports", "ibas/index", "../../borep/bo/index", "../../borep/BORepositories", "./OrganizationViewApp", "./OrganizationEditApp"], function (require, exports, ibas, bo, BORepositories_1, OrganizationViewApp_1, OrganizationEditApp_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class OrganizationListApp extends ibas.BOListApplication {
        constructor() {
            super();
        ...
        viewData(data) {
            ...
            let app = new OrganizationViewApp_1.OrganizationViewApp();
            app.navigation = this.navigation;
            app.viewShower = this.viewShower;
            app.run(data);
        }
    ...
    OrganizationListApp.APPLICATION_ID = "930be3fa-50ac-4f47-856f-64ba09060821";
    OrganizationListApp.APPLICATION_NAME = "initialfantasy_app_organization_list";
    OrganizationListApp.BUSINESS_OBJECT_CODE = bo.Organization.BUSINESS_OBJECT_CODE;
    exports.OrganizationListApp = OrganizationListApp;
});
