...
export class ProjectListApp extends ibas.BOListApplication<IProjectListView, bo.Project> {
    ...
    /** 应用标识 */
    static APPLICATION_ID: string = "83062662-21bb-4172-8102-036a5813e651";
    /** 应用名称 */
    static APPLICATION_NAME: string = "initialfantasy_app_project_list";
    /** 业务对象编码 */
    ...
    /** 删除数据，参数：目标数据集合 */
    protected deleteData(data: bo.Project): void {
        // 检查目标数据
        if (ibas.objects.isNull(data)) {
            this.messages(ibas.emMessageType.WARNING, ibas.i18n.prop("sys_shell_please_chooose_data",
