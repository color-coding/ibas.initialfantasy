...
/** 查看应用-项目 */
export class ProjectViewApp extends ibas.BOViewService<IProjectViewView> {

    /** 应用标识 */
    static APPLICATION_ID: string = "a09c985c-eff8-4caf-ad9d-08eb0c67bf17";
    /** 应用名称 */
    static APPLICATION_NAME: string = "initialfantasy_app_project_view";
    /** 业务对象编码 */
    ...
    /** 运行,覆盖原方法 */
    run(...args: any[]): void {
        if (arguments[0] instanceof bo.Project) {
