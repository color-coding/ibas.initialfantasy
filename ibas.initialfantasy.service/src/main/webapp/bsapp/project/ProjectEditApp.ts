...
export class ProjectEditApp extends ibas.BOEditApplication<IProjectEditView, bo.Project> {
    ...
    /** 应用标识 */
    static APPLICATION_ID: string = "bff9b4a7-c4b7-48b6-8fa2-967481dcbd0c";
    /** 应用名称 */
    static APPLICATION_NAME: string = "initialfantasy_app_project_edit";
    /** 业务对象编码 */
    ...
    protected registerView(): void {
        ...
        this.view.chooseTeamMebersEvent = this.chooseTeamMebers;
