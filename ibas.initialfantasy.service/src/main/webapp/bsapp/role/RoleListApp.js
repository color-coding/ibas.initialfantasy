define(["require", "exports", "ibas/index", "../../borep/bo/index", "../../borep/BORepositories", "./RoleViewApp", "./RoleEditApp"], function (require, exports, ibas, bo, BORepositories_1, RoleViewApp_1, RoleEditApp_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class RoleListApp extends ibas.BOListApplication {
        constructor() {
            super();
        ...
        viewData(data) {
            ...
            let app = new RoleViewApp_1.RoleViewApp();
            app.navigation = this.navigation;
            app.viewShower = this.viewShower;
            app.run(data);
        }
    ...
    RoleListApp.APPLICATION_ID = "6bac7ff4-3249-420a-bb93-205a76e2bfa3";
    RoleListApp.APPLICATION_NAME = "initialfantasy_app_role_list";
    RoleListApp.BUSINESS_OBJECT_CODE = bo.Role.BUSINESS_OBJECT_CODE;
    exports.RoleListApp = RoleListApp;
});
