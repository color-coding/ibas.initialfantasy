define(["require", "exports", "ibas/index", "../../borep/bo/index", "../../borep/BORepositories", "./ApprovalRequestViewApp", "./ApprovalRequestEditApp"], function (require, exports, ibas, bo, BORepositories_1, ApprovalRequestViewApp_1, ApprovalRequestEditApp_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class ApprovalRequestListApp extends ibas.BOListApplication {
        constructor() {
            super();
        ...
        viewData(data) {
            ...
            let app = new ApprovalRequestViewApp_1.ApprovalRequestViewApp();
            app.navigation = this.navigation;
            app.viewShower = this.viewShower;
            app.run(data);
        }
    ...
    ApprovalRequestListApp.APPLICATION_ID = "f5b62b33-9e7f-4c88-88e5-87412c11684c";
    ApprovalRequestListApp.APPLICATION_NAME = "initialfantasy_app_approvalrequest_list";
    ApprovalRequestListApp.BUSINESS_OBJECT_CODE = bo.ApprovalRequest.BUSINESS_OBJECT_CODE;
    exports.ApprovalRequestListApp = ApprovalRequestListApp;
});
