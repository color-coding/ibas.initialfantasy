    ...
    export namespace app {
        ...
        export class ApplicationConfigListApp extends ibas.BOListApplication<IApplicationConfigListView, bo.ApplicationConfig> {
            ...
            protected deleteData(data: bo.ApplicationConfig | bo.ApplicationConfig[]): void {
                ...
                let beDeleteds: ibas.ArrayList<bo.ApplicationConfig> = new ibas.ArrayList<bo.ApplicationConfig>();
                ...
                this.messages({
                    ...
                    onCompleted(action: ibas.emMessageAction): void {
                        if (action === ibas.emMessageAction.YES) {
                            try {
                                let boRepository: bo.BORepositoryInitialFantasy = new bo.BORepositoryInitialFantasy();
                                let saveMethod: Function = function (beSaved: bo.ApplicationConfig): void {
