...
namespace initialfantasy {
    export namespace app {
        ...
        /** 列表应用-业务对象信息 */
        export class BOInformationListApp extends ibas.BOListApplication<IBOInformationListView, bo.BOInformation> {

            /** 应用标识 */
            static APPLICATION_ID: string = "3af1afea-2788-4c1a-98bc-4815fd20dcbe";
            /** 应用名称 */
            static APPLICATION_NAME: string = "initialfantasy_app_boinformation_list";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.BOInformation.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = BOInformationListApp.APPLICATION_ID;
                this.name = BOInformationListApp.APPLICATION_NAME;
                this.boCode = BOInformationListApp.BUSINESS_OBJECT_CODE;
            ...
            protected deleteData(data: bo.BOInformation | bo.BOInformation[]): void {
                let beDeleteds: ibas.IList<bo.BOInformation> = ibas.arrays.create(data);
                // 没有选择删除的对象
